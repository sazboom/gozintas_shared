	...
	js : {
		...
		page1: {
			init: function() {
				...
				Gozintas.loadedPage = 'page1';
				$("#page1").on("pageshow", function(e,ui){
					loadPageJS(e,ui);
				});
				$("#page1").on(
					"pagebeforeshow keyup", "#container",
					function () {
		...
		page2: {
			init: function() {
				$("#page2").on("pageshow", function(e,ui){
					loadPageJS(e,ui);
				});
				...
				$("#page2 .extra-popup .close_button").on('click', function(){
		...
		page2b: {
			init: function() {
				$("#page2b").on("pageshow", function(e,ui){
					loadPageJS(e,ui);
				});

				$("#page2b").on('pageshow',function(){
				...
				$("#page2b").on('pageshow click keyup',function(){
						parentClass = "#page2b";
		...
		page4: {
			init: function() {
				$("#page4").on("pageshow", function(e,ui){
					loadPageJS(e,ui);
				});
		...
		page4b: {
			init: function() {
				$("#page4b").on("pageshow", function(e,ui){
					loadPageJS(e,ui);
				});
